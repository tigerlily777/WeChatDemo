...
private val LightColorPalette = WeChatDemoColors(
    bottomBar = white1,
    background = white2,
    listItem = white,
    divider = white3,
...
private val DarkColorPalette = WeChatDemoColors(
    bottomBar = black1,
    background = black2,
    listItem = black3,
    divider = black4,
...
private val NewYearColorPalette = WeChatDemoColors(
    bottomBar = red4,
    background = red5,
    listItem = red2,
    divider = red3,
